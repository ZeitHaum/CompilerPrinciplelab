...
struct Generator {
    ...
    void gen_instr(ir::Instruction*, std::vector<rv::rv_inst>& rv_insts,int& stack_space,int& reverse_ptr, stackVarMap& stvm,int i,ir::Function& func);
    ...
    void store_op(ir::Operand op, backend::stackVarMap& stvm, rv::rvREG reg, std::vector<rv::rv_inst>& rv_insts,int& stack_space);
};
